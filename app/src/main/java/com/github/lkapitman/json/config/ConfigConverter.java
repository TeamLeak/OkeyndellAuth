...
public class ConfigConverter {
    ...
    public static OffsetDateTime parseDateTimeString(String str) {
        return ZonedDateTime.from(ConfigConverter.DATE_TIME_FORMATTER.parse(str)).toOffsetDateTime();
    }
    ...
    public static OffsetTime parseTimeString(String str) {
        return ZonedDateTime.from(ConfigConverter.TIME_FORMATTER.parse(str)).toOffsetDateTime().toOffsetTime();
    }
